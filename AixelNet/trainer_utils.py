...
class TrainDataset(Dataset): 
    ...
    def __init__(self, trainset):
        ...
        """
        (self.inputs, self.y, self.meta_features), self.table_flag = trainset
    ...
    def __getitem__(self, index):
        ...
        return  x_cat_input_ids, x_cat_att_mask, x_num, col_cat_input_ids, col_cat_att_mask, num_col_input_ids, num_att_mask, y, self.table_flag, meta_features
...
class SupervisedTrainCollator():
    ...
    def __call__(self, data):
        ...
        return inputs, y, meta_features, table_flag
